...
public class ContentWithSpaceEditText extends AppCompatEditText {
    ...
    private boolean inputTypeLimit;
    ...
    private void parseAttributeSet(Context context, AttributeSet attrs) {
        ...
        inputTypeLimit = ta.getBoolean(R.styleable.ContentWithSpaceEditText_inputTypeLimit, false);
        maxLength = ta.getInt(R.styleable.ContentWithSpaceEditText_maxLength, 100);
        ta.recycle();
        if (inputTypeLimit) {
            initType();
        }
    ...
    public void setInputType(int type) {
        ...
        if (!TextUtils.isEmpty(digits) && inputTypeLimit) {
